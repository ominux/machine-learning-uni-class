%% ML  2017
%  Ex.  Regularized Linear Regression and Bias-Variance
%% 
...
%  You should now implement the cost and gradient for regularized linear 
%  regression.
%
theta = [1 ; 1];
lambda=1;
...
%Second way to implement feature normalization code (both are equal) 
